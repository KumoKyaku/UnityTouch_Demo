...
{
	[Serializable]
	[NodeAttributes( "Texture Coordinates", "Surface Standard Inputs", "Texture UV coordinates set, if <b>Tex</b> is connected to a texture object it will use that texture scale factors, otherwise uses <b>Tilling</b> and <b>Offset</b> port values", null, KeyCode.U )]
