...
namespace AmplifyShaderEditor
{
	...
	public sealed class CustomStandardSurface : ParentNode
	{
		...
		public override string GenerateShaderForOutput( int outputId, ref MasterNodeDataCollector dataCollector, bool ignoreLocalvar )
		{
			...
			dataCollector.AddLocalVariable( UniqueId, "UnityGI gi" + OutputId + " = UnityGlobalIllumination( data, s" + OutputId + ".Occlusion, s" + OutputId + ".Normal, g" + OutputId + " );\n" );
			...
			//float4 inside = LightingStandard( z, viewDir, giin );
