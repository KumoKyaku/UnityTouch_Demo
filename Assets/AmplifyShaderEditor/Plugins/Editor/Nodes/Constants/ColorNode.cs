	...
	public sealed class ColorNode : PropertyNode
	{
		...
		public override void Draw( DrawInfo drawInfo )
		{
			...
			if ( m_isVisible )
			{
				...
				{
					EditorGUI.BeginChangeCheck();
					m_materialValue = EditorGUIColorField( newPos, m_dummyContent, m_materialValue, false, true, m_isHDR, m_hdrConfig );
				...
				else
				{
					...
					m_defaultValue = EditorGUIColorField( newPos, m_dummyContent, m_defaultValue, false, true, m_isHDR, m_hdrConfig );
					if ( EditorGUI.EndChangeCheck() )
					{
						BeginDelayedDirtyProperty();
					}
