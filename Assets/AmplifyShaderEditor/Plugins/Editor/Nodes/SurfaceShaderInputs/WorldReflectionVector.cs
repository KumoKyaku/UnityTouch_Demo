...
{
	[Serializable]
	[NodeAttributes( "World Reflection", "Surface Standard Inputs", "Per pixel world reflection vector, accepts a <b>Normal</b> vector in tangent space (ie: normalmap)", null, KeyCode.R )]
