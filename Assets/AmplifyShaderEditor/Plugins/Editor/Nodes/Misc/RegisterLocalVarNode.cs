...
{
	[Serializable]
	[NodeAttributes( "Register Local Var", "Misc", "Forces a local variable to be written with the given name. Can then be fetched at any place with a <b>Get Local Var</b> node." )]
